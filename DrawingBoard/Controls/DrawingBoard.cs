...
using DrawingBoard.Forms;
using DrawingBoard.Shapes;
using DrawingBoard.Handlers;
...
namespace DrawingBoard.Controls
{
    ...
    /// </summary>
    //[Designer("DrawingBoard.Controls.DrawingBoardDesigned, AssemblyContainingTheDesigner")]
    ...
    public partial class DrawingBoard : UserControl
    {
        ...
        private int startDX;
        private int startDY;
        protected ShapeManager shapeManager = new ShapeManager();
        ...
        private Color penColor = Color.Black; //DefaultColor Black; //Current pen color
        ...
        /// See <see cref="DrawingBoard.DrawingBoardStatus"/>
        /// </summary>
        ...
        /// See <see cref="DrawingBoard.HandlerOperator"/>
        /// </summary>
        ...
        protected void DrawingBoard_MouseDown(object sender, MouseEventArgs e)
        {
            this.mouseX = e.X;
            this.mouseY = e.Y;
        ...
        protected void DrawingBoard_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                int tmpX = (int)((e.X) / Zoom - this.dx);
                ...
                switch (this.option)
                {
                    ...
                    case DrawingOption.Pen:
                        this.shapeManager.AddPointSet(RegionCorrection(penPoints, region),
                            this.penColor, this.fillColor, this.penWidth, this.fillEnabled,
                            penPoints, true);
                        this.option = DrawingOption.Select;
                        this.penPoints = null;
        ...
        protected virtual void OptionToNotRedrawInChild()
        {
            this.ReDraw(true);
        }
        #endregion
...
#region My Customization
        private Region RegionCorrection(List<PointElement> points, Region InitialRegion)
        {
            int xMin = 99999;
            int yMin = 99999;
            int xMax = 0;
            ...
            {
                if (point.StartX < xMin)
                    xMin = point.StartX;

                if (point.StartY < yMin)
                    yMin = point.StartY;
            ...
            Region CorrectedRegion = new Region(InitialRegion.X0 + xMin, InitialRegion.Y0 + yMin, InitialRegion.X0 + xMax, InitialRegion.Y0 + yMax);
        ...
        public void ReDraw(bool redrawAll)
        {
            ...
            //Draw A4 margin
            //Pen a4Pen = new Pen(Color.Black, 0.5f);
