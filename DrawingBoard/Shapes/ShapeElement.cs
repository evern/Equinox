...
namespace DrawingBoard.Shapes
{
    ...
    public abstract class ShapeElement 
    {
        ...
        private int gradientDimension = 0; //NOT USED!
        ...
        /// <summary>
        /// Indicates whether shape is <see cref="DrawingBoard.Shapes.Line">Line</see> shape or not
        /// </summary>
